        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo"> Department Information Update </a>
					                ...
					                <div id="login-row" class="row justify-content-center align-items-center">
					                  <div id="login-column" class="col-md-6">
					                    <div id="login-box" class="col-md-12">
					                      <form id="login-form" class="form" action="UpdateDept" method="post">
					                        <h3 class="text-center text-info">Update Department Details</h3><br>
					                        <div class="form-group">
					                        <input type="hidden" name="id" value="${sessionScope.updateDept.getDepartId()}"/>
					                          <label for="username" class="text-info">Department Head:</label><br />
					                          <input
					                            type="text"
					                            name="head"
					                          	value="${sessionScope.updateDept.getDeptHead()}"
					                            class="form-control"
					                            required
					                          />
					                        </div>
					                        <div class="form-group">
					                          ...
					                          <input
					                            type="email"
					                            name="email"
					                          	value="${sessionScope.updateDept.getDeptEmail()}"
					                            class="form-control"
					                            required
					                          />
					                        </div>
					                        <div class="form-group">
					                          ...
					                          <input
					                            type="text"
					                            name="password"
					                         	value="${sessionScope.updateDept.getDeptPassword()}"
					                            class="form-control"
					                            required
					                          />
					                        </div>
					                        ...
					                        <div class="form-group">
					                          ...
					                          <input
					                            ...
					                            name="department_name"
					                          	value="${sessionScope.updateDept.getDeptName()}"
					                            class="form-control"
					                            required
					                            disabled
					                          />
