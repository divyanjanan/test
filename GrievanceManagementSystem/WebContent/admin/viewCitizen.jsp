...
<%@page import="com.cybage.model.Citizens"%>
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo"> Citizens </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">PCMC Citizen Details</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                             <c:forEach items="${sessionScope.citizenList}" var="citizen">
									        	<tr>
									        		<td><c:out value="${citizen.getCitizenId() }"></c:out></td>
									        		<td><c:out value="${citizen.getName()}"></c:out></td>
									        		<td><c:out value="${citizen.getEmail()}"></c:out></td>
									        		<td><c:out value="${citizen.getMobile()}"></c:out></td>
									        		<td><c:out value="${citizen.getGender()}"></c:out></td>
									        		<td><c:out value="${citizen.getAddress()}"></c:out></td>
									        	</tr>
									        </c:forEach>
