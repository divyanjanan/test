...
<head>
    ...
    <title>Citizen - Complaint Reminders</title>
    ...
    -->
            <div class="sidebar-wrapper" >
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="NewComplaint">
                            <i class="nc-icon nc-notes"></i>
                            <p>Register Complaint</p>
                        </a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="CitizenComplaintReminder">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#">Complaint Reminder </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">My Complaints Reminders</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.myReminderList}" var="complaint">
									        	<tr>
									        		...
									        		<td>
									       				<form action="SendReminder" method="post"><input type="hidden" name="complaint_id" value="${complaint.getCpId() }" /><button class="btn btn-success btn-sm" type="submit">Send Reminder</button></form>
									        		</td>
									        	</tr>
