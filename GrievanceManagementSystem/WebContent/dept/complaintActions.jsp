...
<head>
    ...
    <title>Dept - Complaint Actions</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.complaintAction1}" var="complaint">
									        	<tr>
									        		...
									        		<td><form action="UpdateComplaint" method="post"><input type="hidden" name="complaint_id" value="${complaint.getCpId() }" /><button style="margin-right: 10px" class="btn btn-warning btn-sm" type="submit">Process</button></form></td>
									        	</tr>
                        ...
                        <div class="col-md-6">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Under Process Complaints</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        <thead>
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.complaintAction2}" var="complaint">
									        	<tr>
									        		<td><c:out value="${complaint.getCpId() }"></c:out></td>
									        		<td><c:out value="${complaint.getCtName() }"></c:out></td>
									        		<td><c:out value="${complaint.getCpDetails() }"></c:out></td>
									        		<td><c:out value="${complaint.getStatus() }"></c:out></td>
									        		<td><form action="UpdateComplaint" method="post"><input type="hidden" name="complaint_id" value="${complaint.getCpId() }" /><button style="margin-right: 10px" class="btn btn-danger btn-sm" type="submit">Close</button></form></td>
									        	</tr>
