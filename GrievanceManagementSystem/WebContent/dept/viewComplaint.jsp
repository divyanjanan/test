...
<head>
    ...
    <title>Dept - Complaint Report</title>
                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.deptComplaint}" var="complaint">
									        	<tr>
									        		<td><c:out value="${complaint.getCpId() }"></c:out></td>
									        		<td><c:out value="${complaint.getCtName() }"></c:out></td>
									        		<td><c:out value="${complaint.getCtMobile() }"></c:out></td>
									        		<td><c:out value="${complaint.getCtAddress() }"></c:out></td>
