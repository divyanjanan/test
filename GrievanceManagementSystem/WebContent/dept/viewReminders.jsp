                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Complaint Reminders</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.viewReminder}" var="complaint">
									        	<tr>
									        		...
									        		<td><c:out value="${complaint.getRmDate() }"></c:out></td>
									        	</tr>
