 ...
 */
@WebServlet("/dept/ReassignDept")
public class ReassignDept extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 DeptService service;  
	     ...
	     */
	    public ReassignDept() throws ClassNotFoundException, SQLException {
	        super();
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			ArrayList<Complaint> complaints=(ArrayList<Complaint>) service.complaintFiledList(user.getDeptId());
			session.setAttribute("reassignList",complaints);
