 ...
 */
@WebServlet("/dept/UpdateComplaint")
public class UpdateComplaint extends HttpServlet {
     ...
     */
    public UpdateComplaint() throws ClassNotFoundException, SQLException {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
			try(PrintWriter printWriter=response.getWriter()){
				...
				String msg = service.updateComplaint(id);
				
				PrintWriter out = response.getWriter();
				out.println("<script type=\"text/javascript\">");
				   out.println("alert('"+msg+"');");
				   out.println("location='ComplaintActions';");
				   out.println("</script>");
			}
		}
